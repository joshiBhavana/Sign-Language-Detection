# Sign Language Detection (Text and Audio output)
...
[data_collection_binary](https://github.com/joshiBhavana/Sign-Language-Detection/blob/my-new-branch/Files/data_collection_binary.py)
...
Link to Dataset: 
[Dataset](https://github.com/joshiBhavana/Sign-Language-Detection/tree/my-new-branch/Dataset/images1)
...
[Skeleton_images](https://github.com/joshiBhavana/Sign-Language-Detection/blob/my-new-branch/Files/skeleton_images.py)


Dataset after landmarking on the hand:
[Dataset](https://github.com/joshiBhavana/Sign-Language-Detection/tree/my-new-branch/Dataset/Skeleton_Images)
...
[Skeleton_mapping](https://github.com/joshiBhavana/Sign-Language-Detection/blob/my-new-branch/Files/skeleton_mapping.py)

Dataset after mapping the landmarks:
[Dataset](https://github.com/joshiBhavana/Sign-Language-Detection/tree/my-new-branch/Dataset/AtoZ_3.1)
...
![Alt Text](https://imgur.com/a/5PhtBgT)
